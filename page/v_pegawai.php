<?php
    ...
    include 'proses/m_pegawai.php';
?>
            <h3 class="mb-3"><i class="fa-solid fa-user-tie mr-2"></i>Daftar Pegawai</h3><hr>
            <a href="#" class="btn btn-primary btn-sm text-white mb-2" data-toggle="modal" data-target="#tambah-dosen"><i class="fa-solid fa-plus mr-2"></i>Tambah Pegawai</a>
           ...
           <?php } ?>
            ...
            <table class="table table-striped table-bordered table-hover">
                ...
                <?php
                    $no = 1;
                    $tampil = mysqli_query($conn, "SELECT * FROM m_pegawai");
...
<div class="modal fade" id="edit-dosen-<?php echo $data['id']; ?>" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="edit-dosen-<?php echo $data['id']; ?>Label" aria-hidden="true">
  ...
  <div class="modal fade" id="tambah-dosen" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="tambah-mhsLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header bg-primary text-white">
          <h5 class="modal-title" id="tambah-mhsLabel"><i class="fa-solid fa-user-tie mr-2"></i>Tambah Data Petugas</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
